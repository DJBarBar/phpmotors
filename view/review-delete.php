...
<h1>Delete <?php if (isset($vehicleName)) {
                echo $vehicleName;
            } ?>Review </h1>
<h2>Reviewed on <?php if (isset($reviewDate)) {
                    echo $reviewDate;
                } ?></h2>
...
<form id="deleting_form" action="/phpmotors/reviews/index.php" method="POST">
    ...
    <textarea class="customer_review" id="customer_review" name="reviewText" readonly><?php if (isset($reviewText)) {
                                                                                            echo $reviewText;
                                                                                        } ?></textarea><br>
