...
VALUES (
    ...
    'Maughan',
    'geophray@gmail.com',
    '$2y$10$Ut/vGth.DS76sdWbh2rYOebNO872SuRtVrovsQIWlOcLzCEURuIg6',
    '1',
    NULL
  ),
  (
    ...
    'User',
    'admin@cit336.net',
    '$2y$10$zMUCsvVUuBHz4u7x6mw.RuuDN3v.wEaAcWwN63CCz613ERdmQ8nwi',
    '3',
    NULL
  ),
  (
    ...
    'Kallie',
    'Maughan',
    'kallie.maughan@gmail.com',
    '$2y$10$KzZXvK14gPBRl/4fkT8C.uth7zZgGwDD0CuGq/AjDNpcuHyGGu7BC',
    '1',
    NULL
  ),
  (
    ...
    'Geophreigh',
    'Maughan',
    'geophray+234556@gmail.com',
    '$2y$10$2uNYFjF3oLsBI9uRSUMyuOyJlDW7fviCo40HT38MXrbpDR0UFtdWa',
    '1',
    NULL
  ),
  (
    ...
    'Geophreigh',
    'Maughan',
    'geophray+test@gmail.com',
    '$2y$10$8HDFzv/21jVLtperghlYHOkeW.10dB27v7JJ6DIKyM4dbMqUG.U8.',
    '1',
    NULL
  );
-- --------------------------------------------------------
...
VALUES (
  ...
  (
    ...
    'FBI',
    'Surveillance Van',
    'Do you like police shows? You&#39;ll feel right at home driving this van, comes complete with surveillance equipment for an extra fee of $2,000 a month. ',
...
VALUES (
  ...
  (
    4,
    'This IS a pretty sweet car. I would like one too.',
    '2020-03-18 19:32:22',
    6,
    5
  ),
  (
    6,
    'This is my daily driver. It&#39;s a little bit of a gas hog, but traffic us never an issue.',
    '2020-03-18 19:38:50',
    4,
    5
  ),
  (
    7,
    'Drove this bad boy off the dealership lot yesterday and I have zero regrets...',
    '2020-03-18 20:22:27',
    10,
    5
  ),
  (
    8,
    'This is my dream car. Very fuel efficient!',
    '2020-03-28 01:49:02',
    8,
    5
  );
